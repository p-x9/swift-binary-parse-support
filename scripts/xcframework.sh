...
binary_parse_support() {
    archive_project "BinaryParseSupport" "iOS"
    archive_project "BinaryParseSupport" "iOS Simulator"
    archive_project "BinaryParseSupport" "macOS"
    archive_project "BinaryParseSupport" "macCatalyst"
    archive_project "BinaryParseSupport" "watchOS"
    archive_project "BinaryParseSupport" "watchOS Simulator"
    archive_project "BinaryParseSupport" "tvOS"
    archive_project "BinaryParseSupport" "tvOS Simulator"
    archive_project "BinaryParseSupport" "visionOS"
    archive_project "BinaryParseSupport" "visionOS Simulator"

    create_xcframework "BinaryParseSupport"
    zip_xcframework "BinaryParseSupport"
}
...
print_checksum "BinaryParseSupport"
